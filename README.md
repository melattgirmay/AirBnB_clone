...
This project is interpreted/tested on Ubuntu 20.04 LTS using Turtle Python

## Installation

- Clone this repository: git clone "https://github.com/melattgirmay/AirBnB_clone.git"
...
- Melat Girmay - (https://github.com/melattgirmay)
